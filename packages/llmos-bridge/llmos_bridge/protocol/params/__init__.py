...
from llmos_bridge.protocol.params.triggers import PARAMS_MAP as TRIGGERS_PARAMS
from llmos_bridge.protocol.params.module_manager import PARAMS_MAP as MODULE_MANAGER_PARAMS
...
ALL_PARAMS: dict[str, dict[str, type]] = {
    ...
    "triggers": TRIGGERS_PARAMS,
    "window_tracker": WINDOW_TRACKER_PARAMS,
    "module_manager": MODULE_MANAGER_PARAMS,
}
